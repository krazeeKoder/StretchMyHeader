...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    @IBOutlet var scrollyImageView: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        tableView.addSubview(scrollyImageView)
    ...
    func updateHeaderView() {
        ...
        scrollyImageView.frame = headerRect
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("NewsCell", forIndexPath: indexPath) as! NewsItemCell
        cell.newsItem = self.items[indexPath.row]
        return cell
    }
